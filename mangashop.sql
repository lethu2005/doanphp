...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 06, 2023 lúc 08:19 AM
...
CREATE TABLE `news` (
  ...
  `name_news` varchar(200) NOT NULL,
  `image` varchar(200) NOT NULL,
  `time` date NOT NULL,
  `content_news` varchar(3000) NOT NULL,
...
(1, 'Lê Minh Thư', 'Thư', '981', 'user1.png', 'Da Nang', 'leminhthu2k3@gmail.com', 123456789, 1, 1),
(21, 'Lê Minh Thư', 'admin', '123', 'close_icon.png', 'Cầu Tam Kỳ', 'thulvmpd05940@fpt.edu.vn', 328846202, 1, 0),
(27, 'Quách Văn Dương', 'abc', '123', 'img-email.png', 'Phú Ninh', 'nts@fpt.edu.vn', 328846202, 1, 0);
